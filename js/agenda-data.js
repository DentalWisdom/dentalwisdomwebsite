...
window.AGENDA_DATA = [
  ...
  { day: "Thursday", time: "2:00 – 4:00 PM", title: "Beyond the Extraction: Advanced Surgical Solutions for the Modern Dental Practice", speaker: "Dr. Gabe Hershman", speakerUrl: "/conference-speakers#speaker-gabe-hershman", location: "Shul", ce: true, ceCredits: 2 },
  ...
  { day: "Thursday", time: "6:30 – 8:00 PM", title: "Intraosseous Anesthesia: Advanced Techniques for Predictable & Profound Pain Control", speaker: "Dr. Sara Werb", speakerUrl: "/conference-speakers#speaker-sara-werb", location: "301A1", ce: true, ceCredits: 1.5, concurrent: "thu-630-breakout", sponsor: "NuSmile", sponsorUrl: "/conference-sponsors" },
  ...
  { day: "Thursday", time: "6:30 – 8:00 PM", title: "Place & Restore: A Hands-On Implant Workshop from Surgery to Final Crown", speaker: "Speaker TBD", location: "311A1", ce: true, ceCredits: 1.5, concurrent: "thu-630-breakout", sponsor: "Adin", sponsorUrl: "/conference-sponsors" },
  ...
  { day: "Friday", time: "9:00 – 10:00 AM", title: "Built to Scale: 1 to 3+ Locations", speaker: "Dr. Marc Faber", speakerUrl: "/conference-speakers#speaker-marc-faber", location: "Shul", ce: true, ceCredits: 1 },
  { day: "Friday", time: "10:00 AM – 12:00 PM", title: "'Hopeless' to Heroic: Modern Approaches to Periodontal Regeneration and Plastic Surgery", speaker: "Dr. Sean Ference", speakerUrl: "/conference-speakers#speaker-sean-ference", location: "Shul", ce: true, ceCredits: 2 },
  { day: "Friday", time: "12:00 – 1:30 PM", title: "Lunch", speaker: "", location: "OVO at The Altair", event: true, sponsor: "Sponsor TBD" },
  { day: "Friday", time: "1:30 – 3:00 PM", title: "Straight Talk: Game-Changing Tips and Tricks Every GP Should Know in Orthodontics", speaker: "Dr. Dan German", speakerUrl: "/conference-speakers#speaker-dan-german", location: "Shul", ce: true, ceCredits: 2, sponsor: "orthobrain", sponsorUrl: "/conference-sponsors" },
  { day: "Friday", time: "3:00 – 5:00 PM", title: "Hands-On Zirconia Crown Mastery: Anterior Esthetics & Posterior Strength Workshop", speaker: "Dr. Sara Werb", speakerUrl: "/conference-speakers#speaker-sara-werb", location: "301A1", ce: true, ceCredits: 2, concurrent: "fri-300-breakout", sponsor: "NuSmile", sponsorUrl: "/conference-sponsors" },
  { day: "Friday", time: "3:00 – 5:00 PM", title: "Place & Restore: A Hands-On Implant Workshop from Surgery to Final Crown", speaker: "Speaker TBD", location: "310A1", ce: true, ceCredits: 2, concurrent: "fri-300-breakout" },
